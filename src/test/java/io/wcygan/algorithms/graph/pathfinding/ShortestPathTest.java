...
public class ShortestPathTest {
  ...
  @ParameterizedTest
  @MethodSource("shortestPathGraphProvider")
  public void testShortestPath(int start, int end, Integer[][] edges, Integer[][] expectedEdges) {
    ...
    Graph<Integer> shortestPath = ShortestPath.SinglePair(initial, startingVertex, endingVertex);
    Graph<Integer> expected = buildGraph(expectedEdges);

    // TODO @wcygan: verify the shortestPath graph against the expected graph

    throw new RuntimeException("Not implemented");
  }

  private static Stream<Arguments> shortestPathGraphProvider() {
    return Stream.of(
        Arguments.of(
            // The starting vertex
            1,
